...
public class CostDetailInpat {
    ...
    @MetadataDescribe(id= "LHDE0051038",name = "录入日期时间",eName = "INPUT_DATE_TIME")
    ...
    @MetadataDescribe(id= "LHDE0051063",name = "发票分类代码",eName = "RCPT_CLASS_CODE")
    private String rcptClassCode;

    @MetadataDescribe(id= "LHDE0051064",name = "发票分类名称",eName = "RCPT_CLASS_NAME")
    ...
    @MetadataDescribe(id= "LHDE0051067",name = "财务分类代码",eName = "ACCOUNT_CLASS_CODE")
    private String accountClassCode;

    @MetadataDescribe(id= "LHDE0051068",name = "财务分类名称",eName = "ACCOUNT_CLASS_NAME")
    private String accountClassName;

    @MetadataDescribe(id= "LHDE0051069",name = "病案费用分类代码",eName = "MR_CLASS_CODE")
    private String mrClassCode;

    @MetadataDescribe(id= "LHDE0051070",name = "病案费用分类名称",eName = "MR_CLASS_NAME")
    ...
    @MetadataDescribe(id= "LHDE0051095",name = "申请单号",eName = "APPLY_SINGLE_NO")
    private String applySingleNo;
	...
	public String getApplySingleNo() {
		return applySingleNo;
	}

	public void setApplySingleNo(String applySingleNo) {
		this.applySingleNo = applySingleNo;
	}
}
