...
import com.zebone.nhis.webservice.pskq.model.PriceItem;
...
public class PriceItemImpl implements Message {

    private PriceItem priceItem;

    public PriceItemImpl(PriceItem priceItem) {
    ...
    public RequestBody getRequestBody(Map<String, Object> param) throws IllegalAccessException {
        ...
        List<DataElement> dataElements = MessageBodyUtil.dataElementsFactory(priceItem);
