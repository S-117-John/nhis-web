...
public class DrugItem {
    ...
    @MetadataDescribe(id= "LHSD0011001",name = "药品ID",eName = "DRUG_CODE")
    private String drugCode;

    @MetadataDescribe(id= "LHSD0011002",name = "药品名称",eName = "TRADE_NAME")
    private String tradeName;

    @MetadataDescribe(id= "LHSD0011003",name = "拼音简码",eName = "SPELL_CODE")
    private String spellCode;

    @MetadataDescribe(id= "LHSD0011004",name = "五笔简码",eName = "WB_CODE")
    private String wbCode;

    @MetadataDescribe(id= "LHSD0011005",name = "通用名",eName = "REGULAR_NAME")
    private String regularName;

    @MetadataDescribe(id= "LHSD0011006",name = "通用名拼音码",eName = "REGULAR_SPELL")
    private String regularSpell;

    @MetadataDescribe(id= "LHSD0011007",name = "通用名五笔码",eName = "REGULAR_WB")
    private String regularWb;

    @MetadataDescribe(id= "LHSD0011008",name = "通用名自定义码",eName = "REGULAR_CUSTOM")
    private String regularCustom;

    @MetadataDescribe(id= "LHSD0011009",name = "学名",eName = "FORMAL_NAME")
    private String formalName;

    @MetadataDescribe(id= "LHSD0011010",name = "学名拼音码",eName = "FORMAL_SPELL")
    private String formalSpell;

    @MetadataDescribe(id= "LHSD0011011",name = "学名五笔码",eName = "FORMAL_WB")
    private String formalWb;

    @MetadataDescribe(id= "LHSD0011012",name = "学名自定义码",eName = "FORMAL_CUSTOM")
    private String formalCustom;

    @MetadataDescribe(id= "LHSD0011013",name = "别名",eName = "OTHER_NAME;")
    private String otherName;

    @MetadataDescribe(id= "LHSD0011014",name = "别名拼音码",eName = "OTHER_SPELL")
    private String otherSpell;

    @MetadataDescribe(id= "LHSD0011015",name = "别名五笔码",eName = "OTHER_WB")
    private String otherWb;

    @MetadataDescribe(id= "LHSD0011016",name = "别名自定义码",eName = "OTHER_CUSTOM")
    private String otherCustom;

    @MetadataDescribe(id= "LHSD0011017",name = "英文通用名",eName = "ENGLISH_REGULAR")
    private String englishRegular;

    @MetadataDescribe(id= "LHSD0011018",name = "英文别名",eName = "ENGLISH_OTHER")
    private String englishOther;

    @MetadataDescribe(id= "LHSD0011019",name = "英文名",eName = "ENGLISH_NAME")
    private String englishName;

    @MetadataDescribe(id= "LHSD0011020",name = "国际编码",eName = "INTERNATIONAL_CODE")
    private String internationalCode;

    @MetadataDescribe(id= "LHSD0011021",name = "国家编码",eName = "GB_CODE")
    private String gbCode;

    @MetadataDescribe(id= "LHSD0011022",name = "系统类别",eName = "CLASS_CODE")
    private String classCode;

    @MetadataDescribe(id= "LHSD0011023",name = "最小费用代码",eName = "FEE_CODE")
    private String feeCode;

    @MetadataDescribe(id= "LHSD0011024",name = "药品类型代码",eName = "DRUG_TYPE")
    private String drugType;

    @MetadataDescribe(id= "LHSD0011025",name = "药品性质名称",eName = "DRUG_QUALITY")
    private String drugQuality;

    @MetadataDescribe(id= "LHSD0011026",name = "药品级别",eName = "ITEM_GRADE")
    private String itemGrade;

    @MetadataDescribe(id= "LHSD0011027",name = "药品规格",eName = "SPECS")
    private String specs;

    @MetadataDescribe(id= "LHSD0011028",name = "参考零售价",eName = "RETAIL_PRICE")
    private String retailPrice;

    @MetadataDescribe(id= "LHSD0011029",name = "参考批发价",eName = "WHOLESALE_PRICE")
    private String wholesalePrice;

    @MetadataDescribe(id= "LHSD0011030",name = "最新购入价",eName = "PURCHASE_PRICE")
    private String purchasePrice;

    @MetadataDescribe(id= "LHSD0011031",name = "最高零售价",eName = "TOP_RETAILPRICE")
    private String topRetailprice;

    @MetadataDescribe(id= "LHSD0011032",name = "包装单位",eName = "PACK_UNITl")
    private String packUnitl;

    @MetadataDescribe(id= "LHSD0011033",name = "包装数",eName = "PACK_QTY")
    private String packQty;

    @MetadataDescribe(id= "LHSD0011034",name = "最小单位",eName = "MIN_UNIT")
    ...
    @MetadataDescribe(id= "LHSD0011038",name = "用法编码",eName = "USAGE_CODE")
    ...
    @MetadataDescribe(id= "LHSD0011074",name = "操作员",eName = "OPER_CODE")
    ...
    @MetadataDescribe(id= "LHSD0011087",name = "扩展数据1",eName = "EXTEND1")
    private String extend1;

    @MetadataDescribe(id= "LHSD0011088",name = "扩展数据2",eName = "EXTEND2")
    private String extend2;

    @MetadataDescribe(id= "LHSD0011089",name = "扩展数据3",eName = "EXTEND3")
    private String extend3;

    @MetadataDescribe(id= "LHSD0011090",name = "扩展数据4",eName = "EXTEND4")
    private String extend4;

    @MetadataDescribe(id= "LHSD0011091",name = "字典建立时间",eName = "CREATE_TIME")
    private String createTime;

    @MetadataDescribe(id= "LHSD0011092",name = "",eName = "DRUG_TYPETWO")
    private String drugTypetwo;

    @MetadataDescribe(id= "LHSD0011093",name = "参考零售价2",eName = "RETAIL_PRICE2")
    private String retailPrice2;

    @MetadataDescribe(id= "LHSD0011094",name = "预留数字01",eName = "EXT_NUM1")
    private String extNum1;

    @MetadataDescribe(id= "LHSD0011095",name = "预留数字01",eName = "EXT_NUM2")
    ...
    @MetadataDescribe(id= "LHSD0011098",name = "第二基本剂量",eName = "SECOND_BASE_DOSE")
    private String secondBaseDose;

    @MetadataDescribe(id= "LHSD0011099",name = "第二剂量单位",eName = "SECOND_DOSE_UNIT")
    private String secondDoseUnit;

    @MetadataDescribe(id= "LHSD0011100",name = "一次用量单位",eName = "ONCE_DOSE_UNIT")
    ...
    @MetadataDescribe(id= "LHSD0011105",name = "参考零售价（VIP）",eName = "RETAIL_PRICE1")
    private String retailPrice1;

    @MetadataDescribe(id= "LHSD0011106",name = "",eName = "DOCTOR_GRADE")
    private String doctorGrade;

    @MetadataDescribe(id= "LHSD0011107",name = "静配标记",eName = "PIVAS_FORCE_FLAG")
    private String pivasForceFlag;

    @MetadataDescribe(id= "LHSD0011108",name = "",eName = "PIVAS_DRUG_TYPE")
    private String pivasDrugType;

    @MetadataDescribe(id= "LHSD0011109",name = "医院编码",eName = "ORG_CODE")
    ...
    public String getDrugTypetwo() {
        return drugTypetwo;
    }

    public void setDrugTypetwo(String drugTypetwo) {
        this.drugTypetwo = drugTypetwo;
    }
