...
public class Constant {
    ...
    //响应状态
    public static final String RESSUC= "1"; 
    public static final String RESFAIL= "0"; 
    public static final String UNUSUAL= "-1"; 
    
    //上下午模式判断
    public static final String MORNING= "0101"; 
    public static final String AFTERNOON= "0102"; 
