...
public class PacsApplyRecord {
	...
	private String birthdayTxt;		// 出生日期(非空, yyyy-mm-dd) birthday[可能存在为空的情况]
	...
	public String toString() {
		return "{ \"record_sn\":\"" + CommonUtils.getString(recordSn)
			    ...
			    + "\",\"birthday\":\"" + CommonUtils.getString(birthdayTxt)
			    ...
			    + "\",\"body_of_case\":\"" + CommonUtils.getString(bodyOfCase)
