...
public class OnlineOpAmtVo {
	...
	private String hpCodeAttr;//医保扩展属性0301
	
	
	public String getHpCodeAttr() {
		return hpCodeAttr;
	}
	public void setHpCodeAttr(String hpCodeAttr) {
		this.hpCodeAttr = hpCodeAttr;
	}
