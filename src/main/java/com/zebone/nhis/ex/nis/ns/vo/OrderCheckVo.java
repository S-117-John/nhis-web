...
public class OrderCheckVo extends CnOrder{
	...
	private String euExtime;//执行时刻0 设定时间，1 开立时间，2 核对时间 3指定间隔
	...
	private String dtInjtype;//注射药类型
	...
	public String getFlagFunDept() {return flagFunDept;}
	public void setFlagFunDept(String flagFunDept) {this.flagFunDept = flagFunDept;}

	public String getEuExtime() {
		return euExtime;
	}

	public void setEuExtime(String euExtime) {
		this.euExtime = euExtime;
	}
}
