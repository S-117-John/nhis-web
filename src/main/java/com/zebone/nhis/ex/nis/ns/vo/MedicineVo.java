...
public class MedicineVo {
	...
	public String getQuanMin() {
		return quanMin;
	}
	public void setQuanMin(String quanMin) {
	...
	public String getPdPackSize() {
		return pdPackSize;
	}
	public void setPdPackSize(String pdPackSize) {
