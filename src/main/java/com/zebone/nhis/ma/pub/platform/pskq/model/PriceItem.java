...
public class PriceItem {
     ...
     * 物价代码
     */
    @MetadataDescribe(id= "LHDE0013001",name = "物价代码",eName = "PRICE_CODE",property = "priceCode")
     ...
     * 财务会计分类代码
     */
    @MetadataDescribe(id= "LHDE0013011",name = "财务分类代码",eName = "ACCOUNT_CLASS_CODE",property = "accountClassCode")
    private String accountClassCode;

    /**
     * 财务会计分类名称
     */
    @MetadataDescribe(id= "LHDE0013012",name = "财务分类名称",eName = "ACCOUNT_CLASS_NAME",property = "accountClassName")
    private String accountClassName;

    /**
     * 病案分类代码
     */
    @MetadataDescribe(id= "LHDE0013013",name = "病案费用分类代码",eName = "MR_CLASS_CODE",property = "mrClassCode")
    private String mrClassCode;

    /**
     * 病案分类名称
     */
    @MetadataDescribe(id= "LHDE0013014",name = "病案费用分类名称",eName = "MR_CLASS_NAME",property = "mrClassName")
    private String mrClassName;

    /**
     * 发票/收据分类代码
     */
    @MetadataDescribe(id= "LHDE0013015",name = "发票分类代码",eName = "RCPT_CLASS_CODE",property = "rcptClassCode")
    private String rcptClassCode;

    /**
     * 发票/收据分类名称
     */
    @MetadataDescribe(id= "LHDE0013016",name = "发票分类名称",eName = "RCPT_CLASS_NAME",property = "rcptClassName")
