 ...
 */
public class SDNTextLineDecoder implements ProtocolDecoder {
     ...
     */
    public SDNTextLineDecoder(String delimiter) {
     ...
     * and the specified <tt>delimiter</tt>.
     */
    public SDNTextLineDecoder(LineDelimiter delimiter) {
     ...
     * and {@link LineDelimiter#AUTO} delimiter.
     */
    public SDNTextLineDecoder(Charset charset) {
     ...
     * and the specified <tt>delimiter</tt>.
     */
    public SDNTextLineDecoder(Charset charset, String delimiter) {
     ...
     * and the specified <tt>delimiter</tt>.
     */
    public SDNTextLineDecoder(Charset charset, LineDelimiter delimiter) {
        if (charset == null) {
