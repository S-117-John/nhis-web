...
public class ReceiverElement {
    ...
    public ReceiverElement(String id, SoftwareNameElement softwareName, SoftwareProviderElement softwareProvider, OrganizationElement organization) {
        this.id = id;
