...
public class SettlementDetailOutpat {
    ...
    @MetadataDescribe(id= "LHDE0048518",name = "结算电子发票PDF路径",eName = "SETTLEMENT_DETAIL_PDF_URL")
    private String settlementDetailPdfUrl;
    
    @MetadataDescribe(id= "LHDE0048519",name = "结算电子发票状态",eName = "SETTLEMENT_DETAIL_PDF_STATUS")
    private String settlementDetailPdfStatus;
    
    @MetadataDescribe(id= "LHDE0048520",name = "结算主记录ID",eName = "SETTLEMENT_MASTER_ID")
    private String settlementMasterId;

    @MetadataDescribe(id= "LHDE0048521",name = "结算次数",eName = "SETTLEMENT_TIMES")
    private String settlementTimes;

    @TypeCode(value = "code")
    @MetadataDescribe(id= "LHDE0048522",name = "结算类型代码",eName = "ACCOUNT_TYPE_CODE")
    private String accountTypeCode;

    @TypeCode(value = "name")
    @MetadataDescribe(id= "LHDE0048523",name = "结算类型名称",eName = "ACCOUNT_TYPE_NAME")
    private String accountTypeName;

    @MetadataDescribe(id= "LHDE0048524",name = "结算日期时间",eName = "SETTLEMENT_DATE_TIME")
    private String settlementDateTime;

    @MetadataDescribe(id= "LHDE0048525",name = "结算人ID",eName = "SETTLEMENT_OPERA_ID")
    private String settlementOperaId;

    @MetadataDescribe(id= "LHDE0048526",name = "结算人姓名",eName = "SETTLEMENT_OPERA_NAME")
    private String settlementOperaName;

    @MetadataDescribe(id= "LHDE0048527",name = "结算窗口号",eName = "SETTLEMENT_WIN_NO")
    private String settlementWinNo;

    @MetadataDescribe(id= "LHDE0048528",name = "发票分类代码",eName = "RCPT_CLASS_CODE")
    private String rcptClassCode;

    @MetadataDescribe(id= "LHDE0048529",name = "发票分类名称",eName = "RCPT_CLASS_NAME")
    private String rcptClassName;

    @MetadataDescribe(id= "LHDE0048530",name = "结算总费用",eName = "TOTAL_FEE")
    private String totalFee;

    @MetadataDescribe(id= "LHDE0048531",name = "费用状态",eName = "CHARGE_STATUS")
    private String chargeStatus;

    @MetadataDescribe(id= "LHDE0048532",name = "子系统",eName = "SUB_SYSTEM_CODE")
    private String subSystemCode;

    @MetadataDescribe(id= "LHDE0048533",name = "源系统代码",eName = "SOURCE_SYSTEM_CODE")
    ...
    public String getSettlementDetailPdfUrl() {
        return settlementDetailPdfUrl;
    }

    public void setSettlementDetailPdfUrl(String settlementDetailPdfUrl) {

        Base64.Encoder encoder = Base64.getEncoder();
        try {
            byte[] textByte = settlementDetailPdfUrl.getBytes("UTF-8");
            String encodedText = encoder.encodeToString(textByte);
            this.settlementDetailPdfUrl = encodedText;
        } catch (UnsupportedEncodingException e) {
            this.settlementDetailPdfUrl = settlementDetailPdfUrl;
        }

    }

    public String getSettlementDetailPdfStatus() {
        return settlementDetailPdfStatus;
    }

    public void setSettlementDetailPdfStatus(String settlementDetailPdfStatus) {
        this.settlementDetailPdfStatus = settlementDetailPdfStatus;
    }
}
