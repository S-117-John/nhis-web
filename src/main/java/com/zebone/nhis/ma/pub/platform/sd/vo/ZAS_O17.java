 ...
 * <ul>
		                 ...
		                 * <li>3: RAS_O17_PATIENT (a Group object) <b>optional </b> </li>
		                 * <li>4: RAS_O17_ORDER (a Group object) <b> repeating</b> </li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class ZAS_O17 extends AbstractMessage  {
     ...
     */
    public ZAS_O17(ModelClassFactory factory) {
       super(factory);
       init(factory);
    }
    ...
    public RAS_O17_PATIENT getPATIENT() { 
       return getTyped("RAS_O17_PATIENT", RAS_O17_PATIENT.class);
    }
    ...
    public RAS_O17_ORDER getORDER() { 
       return getTyped("RAS_O17_ORDER", RAS_O17_ORDER.class);
    }
    ...
    public RAS_O17_ORDER getORDER(int rep) { 
       return getTyped("RAS_O17_ORDER", rep, RAS_O17_ORDER.class);
    }
    ...
    public java.util.List<RAS_O17_ORDER> getORDERAll() throws HL7Exception {
    	return getAllAsList("RAS_O17_ORDER", RAS_O17_ORDER.class);
    } 
    ...
    public void insertORDER(RAS_O17_ORDER structure, int rep) throws HL7Exception { 
       super.insertRepetition( "RAS_O17_ORDER", structure, rep);
    }
    ...
    public RAS_O17_ORDER insertORDER(int rep) throws HL7Exception { 
       return (RAS_O17_ORDER)super.insertRepetition("RAS_O17_ORDER", rep);
    }
    ...
    public RAS_O17_ORDER removeORDER(int rep) throws HL7Exception { 
       return (RAS_O17_ORDER)super.removeRepetition("RAS_O17_ORDER", rep);
    }
