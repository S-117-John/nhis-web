 ...
 */
public class SDNTextLineEncoder extends ProtocolEncoderAdapter {
     ...
     */
    public SDNTextLineEncoder(String delimiter) {
     ...
     * and the specified <tt>delimiter</tt>.
     */
    public SDNTextLineEncoder(LineDelimiter delimiter) {
     ...
     * and {@link LineDelimiter#UNIX} delimiter.
     */
    public SDNTextLineEncoder(Charset charset) {
     ...
     * and the specified <tt>delimiter</tt>.
     */
    public SDNTextLineEncoder(Charset charset, String delimiter) {
     ...
     * and the specified <tt>delimiter</tt>.
     */
    public SDNTextLineEncoder(Charset charset, LineDelimiter delimiter) {
        if (charset == null) {
