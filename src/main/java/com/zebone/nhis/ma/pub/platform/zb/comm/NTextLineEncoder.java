 ...
 */
public class NTextLineEncoder extends ProtocolEncoderAdapter {
     ...
     */
    public NTextLineEncoder(String delimiter) {
     ...
     * and the specified <tt>delimiter</tt>.
     */
    public NTextLineEncoder(LineDelimiter delimiter) {
     ...
     * and {@link LineDelimiter#UNIX} delimiter.
     */
    public NTextLineEncoder(Charset charset) {
     ...
     * and the specified <tt>delimiter</tt>.
     */
    public NTextLineEncoder(Charset charset, String delimiter) {
     ...
     * and the specified <tt>delimiter</tt>.
     */
    public NTextLineEncoder(Charset charset, LineDelimiter delimiter) {
        if (charset == null) {
