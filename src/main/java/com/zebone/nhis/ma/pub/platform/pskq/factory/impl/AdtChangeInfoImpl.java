...
import com.zebone.nhis.ma.pub.platform.pskq.model.AdtChangeInfo;
...
public class AdtChangeInfoImpl implements Message {

    private AdtChangeInfo adtChangeInfo;

    public AdtChangeInfo getAdtChangeInfo() {
        return adtChangeInfo;
    }

    public void setAdtChangeInfo(AdtChangeInfo adtChangeInfo) {
        this.adtChangeInfo = adtChangeInfo;
    }

    public AdtChangeInfoImpl(AdtChangeInfo adtChangeInfo) {
        this.adtChangeInfo = adtChangeInfo;
    }
    ...
    public RequestBody getRequestBody(Map<String, Object> param) throws IllegalAccessException {
        ...
        List<DataElement> dataElements = MessageBodyUtil.dataElementsFactory(adtChangeInfo);
        Map<String,Object> map = new HashMap<>();
        map.put("ADT_CHANGE_INFO",dataElements);
