 ...
 */
public class NTextLineDecoder implements ProtocolDecoder {
     ...
     */
    public NTextLineDecoder(String delimiter) {
     ...
     * and the specified <tt>delimiter</tt>.
     */
    public NTextLineDecoder(LineDelimiter delimiter) {
     ...
     * and {@link LineDelimiter#AUTO} delimiter.
     */
    public NTextLineDecoder(Charset charset) {
     ...
     * and the specified <tt>delimiter</tt>.
     */
    public NTextLineDecoder(Charset charset, String delimiter) {
     ...
     * and the specified <tt>delimiter</tt>.
     */
    public NTextLineDecoder(Charset charset, LineDelimiter delimiter) {
        if (charset == null) {
