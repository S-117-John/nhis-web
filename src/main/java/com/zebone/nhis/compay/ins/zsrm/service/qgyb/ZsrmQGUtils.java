...
public class ZsrmQGUtils {
    private static final Logger logger = LoggerFactory.getLogger(ZsrmQGUtils.class);
    /*** 获取当前时间戳 */
   ...
   public static void mapToBean(Object target, Map source){
       ...
       try {
           ...
           logger.error("map转实体类出错"+e.getMessage());
           e.printStackTrace();
       }
   }
}
