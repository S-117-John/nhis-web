...
@Mapper
public interface ZsbaSelfPayTrInsuMapper {
	
	/**查询患者门诊挂号结算信息*/
	public List<Map<String,Object>> qryOpRegStInfo(Map<String,Object> paramMap);
	
	/**根据结算主键查询关联的费用明细*/
	public List<ZsbaBlOpDt> qryDtListByPkSettle(@Param("pkList") List<String> pkList);
	public List<ZsbaBlOpDt> findDtListByPkSettle(Map<String,Object> paramMap);
