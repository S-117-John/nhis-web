...
/**
 * Table: tp_serv_item_type - 第三方服务项目类型 
 *
 * @since 2017-09-07 12:29:02
 */
@Table(value="TP_SERV_ITEM_TYPE")
public class TpServItemType{

    /** PK_ITEM_TYPE - 项目类型主键 */
	@PK
	@Field(value="PK_ITEM_TYPE",id=KeyId.UUID)
    private String pkItemType;

    /** FK_PARENT - 上级类型主键 */
	@Field(value="FK_PARENT")
    ...
    public String getPkItemType(){
        return this.pkItemType;
    }
    public void setPkItemType(String pkItemType){
        this.pkItemType = pkItemType;
    }
