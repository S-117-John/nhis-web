...
public class OprbFeesDto {
	...
	private String reChargeSetlId;//部分退医保重结主键
	...
	public String getReChargeSetlId() {
		return reChargeSetlId;
	}

	public void setReChargeSetlId(String reChargeSetlId) {
		this.reChargeSetlId = reChargeSetlId;
	}
}
