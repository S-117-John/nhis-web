...
public class ZsbaBlInvPrint {
	...
	public List<ZsbaBlInvoice> getBlInvoice() {
		return blInvoice;
	}
	...
	public void setBlInvoice(List<ZsbaBlInvoice> blInvoice) {
