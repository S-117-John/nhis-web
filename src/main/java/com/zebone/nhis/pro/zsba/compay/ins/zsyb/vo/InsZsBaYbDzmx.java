...
public class InsZsBaYbDzmx extends BaseModule  {
	...
	public BigDecimal getYbzhzf() {
		return ybzhzf;
	}
	public void setYbzhzf(BigDecimal ybzhzf) {
		this.ybzhzf = ybzhzf;
	}
	...
	public void setCzfje(BigDecimal czfje) {
		this.czfje = czfje;
	}
}