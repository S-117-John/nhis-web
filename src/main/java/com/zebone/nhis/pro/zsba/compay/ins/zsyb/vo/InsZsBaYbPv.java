 ...
 */
@Table(value="INS_PV")
public class InsZsBaYbPv extends BaseModule  {
	...
	//扩展字段
	private String ryzdgjdm2;//入院诊断icd10编码2
	private String ryzdgjdm3;//入院诊断icd10编码3
	private String ryzdgjdm4;//入院诊断icd10编码4
