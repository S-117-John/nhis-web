...
public class FtpUtils {
	...
	public static boolean connectServer() 
		...
		String server = ApplicationUtils.getPropertyValue("ftp.server", "");
		int port =  Integer.parseInt(ApplicationUtils.getPropertyValue("ftp.port", ""));
		String path =  ApplicationUtils.getPropertyValue("ftp.path", "");
		String user =  ApplicationUtils.getPropertyValue("ftp.username", "");
		String password =  ApplicationUtils.getPropertyValue("ftp.password", "");
	...
	public static boolean connectServer(String server, int port, String user, String password, String path) 
			throws SocketException, IOException {
	...
	public UploadStatus upload(String local, String remote) throws IOException {
		...
		if (remote.contains(File.separator)) {
			remoteFileName = remote.substring(remote.lastIndexOf(File.separator) + File.separator.length());
	...
	public UploadStatus createDirecroty(String remote, FTPClient ftpClient) throws IOException {
		...
		String directory = remote.substring(0, remote.lastIndexOf(File.separator) + File.separator.length());
