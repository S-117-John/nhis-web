...
public class ZsbaBlExtPay implements Serializable {
    ...
    /**
	 * 病历本日结标志(1已日结、其他表示未日结)
	 */
	@Field(value = "FLAG_BUS")
	...
	public String getFlagBus() {
		return flagBus;
	}

	public void setFlagBus(String flagBus) {
