...
import com.zebone.nhis.pro.zsba.mz.bl.dao.ZsbaRepEBillDataMapper;
...
@Service
public class ZsbaRepEBillDataService {

	@Autowired
	private ZsbaRepEBillDataMapper repEBillDataMapper;

	@Autowired
	private BoaiInvSettltService invSettltService;

	/**
	 * 交易号：007003008018->022003027099
	 * 查询结算发票信息
	 * @param param
	 * @param user
	 * @return
