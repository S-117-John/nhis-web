...
public class OpCgTransforVo {
	...
	/*博爱支付使用*/
	private List<BlDeposit> refundBlDeposits;//退费支付方式
	private String pkSettleCanc;//退费结算主键
	private String pkSettleRecharge;//重新结算主键

	private String termOfValidity;//是否查询药品医嘱有效期
	...
	public List<BlDeposit> getRefundBlDeposits() {
		return refundBlDeposits;
	}

	public void setRefundBlDeposits(List<BlDeposit> refundBlDeposits) {
		this.refundBlDeposits = refundBlDeposits;
	}
