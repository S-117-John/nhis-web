...
public class SM4Utils {
    ...
    public SM4Utils(String key, boolean isHexString) {
    	this.secretKey = key;
    	this.hexString = isHexString;
    }
    ...
    public static void main(String[] args) {
    	String plainText = "0000071123";
    	SM4Utils sm4 = new SM4Utils();
    	//sm4.secretKey = "0123456789abcdef";
    	sm4.secretKey = "nems";
    	sm4.hexString = false;
    	System.out.println("ecb");
    	String cipherText = sm4.encryptData_ECB(plainText);
    	System.out.println("new-" + cipherText);
    }
