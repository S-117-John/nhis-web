...
public class PvDiag extends BaseModule  {
	...
	/** PK_DIAG_PARENT - 主诊断关联主键 */
	@Field(value="PK_DIAG_PARENT")
    private String pkDiagParent;
	...
	public String getPkDiagParent() {
		return pkDiagParent;
	}
	public void setPkDiagParent(String pkDiagParent) {
		this.pkDiagParent = pkDiagParent;
	}
