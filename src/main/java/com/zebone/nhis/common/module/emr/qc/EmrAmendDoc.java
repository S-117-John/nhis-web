...
public class EmrAmendDoc {
    private String pkAmendDoc;
    ...
    public String getPkAmendDoc() {
        return pkAmendDoc;
    }

    public void setPkAmendDoc(String pkAmendDoc) {
        this.pkAmendDoc = pkAmendDoc == null ? null : pkAmendDoc.trim();
    }
