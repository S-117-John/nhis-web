...
public class IpDeDrugDto {
	...
	//ba-使用参数
	private String codeDeBa;
	
	//发药单号是否完整标志,1 完整；null 否
	private String flagOfCodeDe;
	...
	public String getEuPrio() {
		return euPrio;
	}

	public void setEuPrio(String euPrio) {
		this.euPrio = euPrio;
	}
	...
	public String getCodeDeEt() {
		return codeDeEt;
	}

	public void setCodeDeEt(String codeDeEt) {
		this.codeDeEt = codeDeEt;
	}

	public String getCodeApEt() {
		return codeApEt;
	}

	public void setCodeApEt(String codeApEt) {
		this.codeApEt = codeApEt;
	}
	...
	public String getCodeDeBa() {
		return codeDeBa;
	}

	public void setCodeDeBa(String codeDeBa) {
		this.codeDeBa = codeDeBa;
	}
	...
	public String getFlagOfCodeDe() {
		return flagOfCodeDe;
	}

	public void setFlagOfCodeDe(String flagOfCodeDe) {
		this.flagOfCodeDe = flagOfCodeDe;
	}
}
